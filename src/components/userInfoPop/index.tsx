        ...
        <div className={styles.screen}>
            ...
            <nav className={picDisabled ? `${styles.mainNav} ${styles.toggled}` : `${styles.mainNav}`} role="navigation" >
                <ul>
                    ...
                    {
                        !picUpload &&
                        <img onClick={() => { filesInput.click() }} style={{ borderRadius: '50%' }} height={48} width={48} src={avaterImage} alt="" />
                    }
                    {
                        picUpload && <Spin></Spin>
                    }
                    ...
                    {
                        nameInput &&
                        <li><input type="text" onKeyUp={rename} autoFocus onBlur={() => { setNameInput(false) }} /></li>
                    }
                    <li>
                        <div className={styles.userinfoPopContent}>
                            <div className={styles.indentityBox}>
                                <div className={styles.identityBoxTitle}>
                                    ...
                                    <div className={styles.indentityBoxIcon} onClick={() => { if (indentityContentIndex == 1) { setIndentityContentIndex(0) } else { setIndentityContentIndex(1) } }}>
                            ...
                            <div className={styles.indentityBox}>
                                <div className={styles.identityBoxTitle}>
                                    ...
                                    <div className={styles.indentityBoxIcon} onClick={() => { if (indentityContentIndex == 2) { setIndentityContentIndex(0) } else { setIndentityContentIndex(2) } }}>
                                        <Iconfont type='icon-xia'></Iconfont>
                                    </div>
                                </div>
                                {
                            ...
                            <div className={styles.indentityBox}>
                                <div className={styles.identityBoxTitle}>
                                    <h3>Version</h3>
                                    <div className={styles.indentityBoxIcon} onClick={() => { if (indentityContentIndex == 3) { setIndentityContentIndex(0) } else { setIndentityContentIndex(3) } }}>
                                        <Iconfont type='icon-xia'></Iconfont>
                                    </div>
                                </div>
                                {
            ...
            <div className={picDisabled ? `${styles.container} ${styles.toggled}` : `${styles.container}`} style={{height:'100%',width:'100%'}}>
                <div className={styles.appContent} >
                    <ul className={styles.contentList}>
                        <li>
                            <article>
                                <figure>
                                    <img height={493} width={329} src={avaterImage} alt="The Jim Lewis Dalaman Briefcase" />
                                    <figcaption>
                                    </figcaption>
                                </figure>
                            </article>

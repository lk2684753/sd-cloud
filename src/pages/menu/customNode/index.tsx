...
import web3 from '@/components/HomeCarouselItem/Web3Item';
...
CzAAqYTVOPWO2yYAAAAASUVORK5CYII="
      ...
      <div className={styles.leftList} style={{marginRight:'200px'}}>
        <Card title="Node Address List" bordered={false} style={{ width: 700, height: '600px' }}>
      ...
      <div className={styles.rightForm}>
        <Card
          ...
          bordered={false}
          style={{ width: 700, minHeight: '600px' }}
        >
